...
const highlights = Array.from({ length: 23 }, (_, i) => `/${i + 1}.jpg`);
...
export default function App() {
  ...
  return (
    <div className="font-sans text-slate-900 bg-white min-h-screen">
      ...
      {/* Highlights Gallery */}
      <section className="bg-slate-900 py-16 border-t-2 border-b-2 border-slate-900 mt-8 relative z-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
           ...
           <p className="text-slate-400 mt-2 font-medium">看見球員們在場上的拚搏與汗水（照片可左右滑動，點擊放大檢視）</p>
        </div>
